                        ...
                        <div ref={modalRef} className="bg-white p-8 rounded-2xl flex  flex-col flex-wrap">
                            ...
                            <div className="flex justify-center">
                                <div className="flex justify-center w-24 h-24 md:w-32 md:h-32 rounded-2xl mb-6 gap-8 text-center">
                                    <img loading="lazy" src="/img/hatartalanul/1.jpg" className="rounded-lg object-cover" alt="Határtalanul 1" />
                                    <img loading="lazy" src="/img/hatartalanul/2.jpg" className="rounded-lg object-cover" alt="Határtalanul 2" />
                                    <img loading="lazy" src="/img/hatartalanul/3.jpg" className="rounded-lg object-cover" alt="Határtalanul 3" />
                                </div>
                            </div>
                            <hr />
                            ...
                            <div className="flex justify-center mt-8">
                                <div className="flex justify-center w-24 h-24 md:w-32 md:h-32 rounded-2xl mb-6 gap-8 text-center">
                                    <img loading="lazy" src="/img/hatartalanul/4.jpg" className="rounded-lg object-cover" alt="Határtalanul 4" />
                                    <img loading="lazy" src="/img/hatartalanul/5.jpg" className="rounded-lg object-cover" alt="Határtalanul 5" />
                                    <img loading="lazy" src="/img/hatartalanul/6.jpg" className="rounded-lg object-cover" alt="Határtalanul 6" />
                                </div>
                            </div>
