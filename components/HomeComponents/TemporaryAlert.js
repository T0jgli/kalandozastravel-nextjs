    ...
    return (
        ...
        >
            <div className={`inline-block w-full relative duration-300 px-8 md:px-0 ${modalOpen ? "opacity-100 top-0" : "opacity-0 -top-96"}`}>
                <div class={`flex flex-col p-8 bg-white shadow-md hover:shodow-lg rounded-2xl md:w-1/2 w-full mx-auto my-5 `} ref={modalRef}>
                    <div class="flex flex-col md:flex-row items-center justify-between">
                        <div class="flex flex-col md:flex-row items-center">
                            <HiOutlineExclamation fontSize="2rem" class="w-16 h-16 rounded-2xl p-3 border border-red-100 text-red-700 bg-red-50" />
                            <div class="px-4 py-3 text-gray-600">
                                <p className="text-lg font-semibold text-center md:text-left">FIGYELEM</p>
                                <p className="text-center md:text-left my-4 md:my-0">
                        ...
                        <button
                            ...
                            class="flex-no-shrink bg-red-500 px-5 md:ml-4 py-2 text-sm shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-red-500 text-white rounded-full"
                        >
                            Bezárás
                        </button>
                    </div>
