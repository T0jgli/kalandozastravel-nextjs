                ...
                <div className="flex flex-wrap text-center w-full justify-evenly">
                    <div className="max-w-xl mb-16 md:mb-0">
                        <div className="text-2xl">
                            <h2 className={clsx("pb-6 text-yellow-700 font-medium", caveat.className)}>Élmények</h2>
                    ...
                    <div className="max-w-xl">
                        <div className="text-2xl">
                            <h2 className={clsx("pb-6 text-yellow-700 font-medium", caveat.className)}>Rólunk</h2>
